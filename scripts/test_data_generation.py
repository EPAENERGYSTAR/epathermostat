...
thermostat_type_1 = list(from_csv(thermostat_path)).pop(0)
metrics = next(thermostat_type_1).calculate_epa_field_savings_metrics()
print(
"""
...
thermostat_heat_pump_electric_backup_two_stage_heat_pump_two_stage = list(from_csv(thermostat_path)).pop(0)
metrics = next(thermostat_heat_pump_electric_backup_two_stage_heat_pump_two_stage).calculate_epa_field_savings_metrics()
print(
"""
@pytest.fixture(scope="session")
