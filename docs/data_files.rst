...
.. csv-table::
   ...
   ":code:`rhu1_55F_to_60F_aux_duty_cycle`","decmial","0.0=0%, 1.0=100%","Resistance heat utilization for hourly temperature bin :math:`55 \leq \frac{T_{aux}}{T_{out}} < 60`"
   ":code:`rhu1_30F_to_45F_aux_duty_cycle`","decmial","0.0=0%, 1.0=100%","Resistance heat utilization for hourly temperature bin :math:`30 \leq \frac{T_{aux}}{T_{out}} < 45`"
   ...
   ":code:`rhu1_30F_to_45F_emg_duty_cycle`","decmial","0.0=0%, 1.0=100%","Resistance heat utilization for hourly temperature bin :math:`30 \leq \frac{T_{emerg}}{T_{out}} < 45`"
   ...
   ":code:`rhu1_30F_to_45F_compressor_duty_cycle`","decmial","0.0=0%, 1.0=100%","Resistance heat utilization for hourly temperature bin :math:`30 \leq \frac{T_{comp}}{T_{out}} < 45`"
