...
def test_get_cooling_season_baseline_dailyT(valid_thermostat_id,valid_temperature_in,valid_datetimeindex):
    setpoints = pd.Series(np.arange(0,100,.25),index=valid_datetimeindex)
    ...
    baseline_dailyT = get_cooling_season_baseline_cooling_demand(thermostat_type_2,cooling_season,baseline_setpoints,method="dailyT")

    assert_allclose(baseline_dailyT.values, np.tile(90.425,(16,)))

def test_get_heating_season_baseline_dailyT(valid_thermostat_id,valid_temperature_in,valid_datetimeindex):
    setpoints = pd.Series(np.arange(0,100,.25),index=valid_datetimeindex)
    ...
    baseline_dailyT = get_heating_season_baseline_heating_demand(thermostat_type_2,heating_season,baseline_setpoints,method="dailyT")

    assert_allclose(baseline_dailyT.values, np.tile(86.175,(16,)))
...
def test_get_cooling_season_baseline_cdd_dailyavg(valid_thermostat_id,valid_temperature_in,valid_datetimeindex):
    ...
    assert_allclose(baseline_cdd.values, np.tile(80.425,(16,)))
...
def test_get_heating_season_baseline_hdd_dailyavg(valid_thermostat_id,valid_temperature_in,valid_datetimeindex):
    ...
    assert_allclose(baseline_hdd.values, np.tile(76.175,(16,)))
