...
def metrics_type_1_data():
    ...
    {'_daily_mean_core_day_demand_baseline_baseline_percentile': 27.509646480234462,
    '_daily_mean_core_day_demand_baseline_baseline_regional': 26.783498119838406,
    'alpha': 31.711392085965297,
    'avoided_daily_mean_core_day_runtime_baseline_percentile': 99.54519464962013,
    'avoided_daily_mean_core_day_runtime_baseline_regional': 76.51801928051994,
    'avoided_total_core_day_runtime_baseline_percentile': 88794.31362746116,
    'avoided_total_core_day_runtime_baseline_regional': 68254.07319822378,
    'baseline_daily_mean_core_day_runtime_baseline_percentile': 872.3691856810103,
    'baseline_daily_mean_core_day_runtime_baseline_regional': 849.34201031191,
    'baseline_percentile_core_heating_comfort_temperature': 69.75,
    'baseline_total_core_day_runtime_baseline_percentile': 778153.3136274612,
    'baseline_total_core_day_runtime_baseline_regional': 757613.0731982237,
    'climate_zone': 'Mixed-Humid',
    'cool_stage': '',
    'cool_type': 'heat_pump',
    'core_heating_days_mean_indoor_temperature': 66.69775543605331,
    'core_heating_days_mean_outdoor_temperature': 44.71524057891045,
    'core_mean_indoor_temperature': 66.69775543605331,
    'core_mean_outdoor_temperature': 44.71524057891045,
    'ct_identifier': '8465829e-df0d-449e-97bf-96317c24dec3',
    'cv_root_mean_sq_err': 0.12290033299512844,
    'daily_mean_core_heating_runtime': 772.8239910313902,
    'end_date': '2014-12-31T00:00:00',
    'heat_stage': 'single_stage',
    'heat_type': 'heat_pump_electric_backup',
    'heating_or_cooling': 'heating_ALL',
    'mean_abs_err': 56.8617872314889,
    'mean_abs_pct_err': 0.07357663309028836,
    'mean_demand': 24.370547623275847,
    'mean_sq_err': 9021.262297504982,
    'n_core_heating_days': 892,
    'n_days_both_heating_and_cooling': 212,
    'n_days_in_inputfile_date_range': 1460,
    'n_days_insufficient_data': 13,
    'percent_savings_baseline_percentile': 11.410902205573745,
    'percent_savings_baseline_regional': 9.009093904635622,
    ...
    'root_mean_sq_err': 94.98032584438201,
    'start_date': '2011-01-01T00:00:00',
    'station': '725314',
    'sw_version': '2.0.0a3',
    'tau': -2.388933256408425,
