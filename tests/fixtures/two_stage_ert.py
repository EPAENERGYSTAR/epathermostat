...
def metrics_ert_hpeb_2_hp_2_data():
    ...
    {'_daily_mean_core_day_demand_baseline_baseline_percentile': 14.164354353014346,
    '_daily_mean_core_day_demand_baseline_baseline_regional': 13.262100267122934,
    'alpha': 23.732046610412592,
    'avoided_daily_mean_core_day_runtime_baseline_percentile': 31.70776432867834,
    'avoided_daily_mean_core_day_runtime_baseline_regional': 10.295428307868105,
    'avoided_total_core_day_runtime_baseline_percentile': 4217.132655714219,
    'avoided_total_core_day_runtime_baseline_regional': 1369.291964946458,
    'baseline_daily_mean_core_day_runtime_baseline_percentile': 336.149117712137,
    'baseline_daily_mean_core_day_runtime_baseline_regional': 314.73678169132677,
    'baseline_percentile_core_heating_comfort_temperature': 70.0,
    'baseline_total_core_day_runtime_baseline_percentile': 44707.83265571422,
    'baseline_total_core_day_runtime_baseline_regional': 41859.99196494646,
    'climate_zone': 'Mixed-Humid',
    'cool_stage': 'two_stage',
    'cool_type': 'heat_pump',
    'core_heating_days_mean_indoor_temperature': 68.6204796465762,
    'core_heating_days_mean_outdoor_temperature': 43.26072922688546,
    'core_mean_indoor_temperature': 68.6204796465762,
    'core_mean_outdoor_temperature': 43.26072922688546,
    'ct_identifier': 'c61badb0e0c0a7e06932de804af43111',
    'cv_root_mean_sq_err': 0.2590612574453644,
    'daily_mean_core_heating_runtime': 304.44135338345876,
    'end_date': '2018-12-31T00:00:00',
    'heat_stage': 'two_stage',
    'heat_type': 'heat_pump_electric_backup',
    'heating_or_cooling': 'heating_ALL',
    'mean_abs_err': 60.963780969840585,
    'mean_abs_pct_err': 0.20024802902861139,
    'mean_demand': 12.828280610652563,
    'mean_sq_err': 6220.312824017437,
    'n_core_heating_days': 133,
    'n_days_both_heating_and_cooling': 19,
    'n_days_in_inputfile_date_range': 364,
    'n_days_insufficient_data': 14,
    'percent_savings_baseline_percentile': 9.432648386669705,
    'percent_savings_baseline_regional': 3.2711233344074753,
    ...
    'rhu2_50F_to_55F': 0.0,
    'rhu2_55F_to_60F': nan,
    'root_mean_sq_err': 78.86895982588737,
    'start_date': '2018-01-01T00:00:00',
    'station': '723170',
    'sw_version': '2.0.0a3',
    'tau': 12.822893865969736,
