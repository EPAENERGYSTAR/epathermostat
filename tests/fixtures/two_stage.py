...
def metrics_hpeb_2_hp_2_data():
    ...
    {'_daily_mean_core_day_demand_baseline_baseline_percentile': 14.795564050088865,
    '_daily_mean_core_day_demand_baseline_baseline_regional': 13.884262321218031,
    'alpha': 24.10820191066814,
    'avoided_daily_mean_core_day_runtime_baseline_percentile': 32.31394926116371,
    'avoided_daily_mean_core_day_runtime_baseline_regional': 10.34410318000465,
    'avoided_total_core_day_runtime_baseline_percentile': 4297.755251734773,
    'avoided_total_core_day_runtime_baseline_regional': 1375.7657229406184,
    'baseline_daily_mean_core_day_runtime_baseline_percentile': 356.69444550176524,
    'baseline_daily_mean_core_day_runtime_baseline_regional': 334.7245994206061,
    'baseline_percentile_core_heating_comfort_temperature': 70.0,
    'baseline_total_core_day_runtime_baseline_percentile': 47440.36125173478,
    'baseline_total_core_day_runtime_baseline_regional': 44518.37172294062,
    'climate_zone': 'Mixed-Humid',
    'cool_stage': 'two_stage',
    'cool_type': 'heat_pump',
    ...
    'ct_identifier': 'c61badb0e0c0a7e06932de804af43111',
    'cv_root_mean_sq_err': 0.25071810342224016,
    'daily_mean_core_heating_runtime': 324.3804962406015,
    'end_date': '2018-12-31T00:00:00',
    'heat_stage': 'two_stage',
    'heat_type': 'heat_pump_electric_backup',
    'heating_or_cooling': 'heating_ALL',
    'mean_abs_err': 62.68576283683635,
    'mean_abs_pct_err': 0.19324763221997385,
    'mean_demand': 13.455192446229665,
    'mean_sq_err': 6614.253799550378,
    'n_core_heating_days': 133,
    'n_days_both_heating_and_cooling': 19,
    'n_days_in_inputfile_date_range': 364,
    'n_days_insufficient_data': 14,
    'percent_savings_baseline_percentile': 9.059280195885133,
    'percent_savings_baseline_regional': 3.090332529461488,
    ...
    'rhu2_50F_to_55F': 0.0,
    'rhu2_55F_to_60F': nan,
    'root_mean_sq_err': 81.3280628046087,
    'start_date': '2018-01-01T00:00:00',
    'station': '723170',
    'sw_version': '2.0.0a3',
    'tau': 12.131985748673614,
